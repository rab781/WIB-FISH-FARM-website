...
const productData = [
    ...
    { id: 9, name: 'Ikan Koki Lionhead', price: 180000, type: 'koki', image: '/images/placeholder.jpg', popularity: 4, stock: 8 },
    { id: 10, name: 'Koi Utsuri', price: 300000, type: 'koi', image: '/images/placeholder.jpg', popularity: 5, stock: 2 },
    { id: 11, name: 'Ikan Koki Panda', price: 160000, type: 'koki', image: '/images/placeholder.jpg', popularity: 3, stock: 10 },
    { id: 12, name: 'Koi Asagi', price: 280000, type: 'koi', image: '/images/placeholder.jpg', popularity: 4, stock: 5 },
    { id: 13, name: 'Ikan Koki Black Moor', price: 170000, type: 'koki', image: '/images/placeholder.jpg', popularity: 4, stock: 6 },
    { id: 14, name: 'Koi Shusui', price: 290000, type: 'koi', image: '/images/placeholder.jpg', popularity: 5, stock: 3 },
    { id: 15, name: 'Ikan Koki Telescope', price: 140000, type: 'koki', image: '/images/placeholder.jpg', popularity: 2, stock: 12 }
];

// Data testimonial dumy
const testimonialData = [
    ...
    { id: 6, text: 'Saya sangat puas dengan pembelian saya. Ikan yang saya beli sangat sehat dan aktif.', name: 'Dewi Lestari', location: 'Yogyakartaa' },
    { id: 7, text: 'Pengalaman berbelanja yang menyenangkan. Ikan sampai dalam kondisi baik dan segar.', name: 'Budi Setiawan', location: 'Semarang, Jawa Tengah' },
    { id: 8, text: 'Pelayanan yang sangat memuaskan. Saya akan merekomendasikan kepada teman-teman saya.', name: 'Siti Nurhaliza', location: 'Medan, Sumatera Utara' },
    { id: 9, text: 'Ikan yang saya beli sangat cantik dan sehat. Terima kasih atas pelayanan yang baik.', name: 'Andi Prabowo', location: 'Bali, Indonesia' },
    { id: 10, text: 'Saya sangat merekomendasikan perusahaan ini untuk membeli ikan hias. Sangat memuaskan!', name: 'Rina Amelia', location: 'Makassar, Sulawesi Selatan' }
];
