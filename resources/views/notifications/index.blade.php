                    ...
                    <div class="p-5 {{ !$notification->is_read ? 'bg-orange-50 font-medium' : 'opacity-70' }}">
                        <div class="flex">
                            ...
                            <div class="ml-4 flex-1">
                                ...
                                @if(!empty($notification->data) && !empty($notification->data['url']))
                                    <a href="{{ $notification->data['url'] }}" class="mt-2 inline-block text-sm text-orange-600 hover:text-orange-800">
                                        Lihat Detail
                                    </a>
                                @endif
