    ...
    <div class="compact-card">
        <div class="compact-header">
            <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
                ...
                <div class="d-flex gap-2">                    <a href="{{ route('admin.pengembalian.index') }}" class="btn btn-light btn-compact">
                        <i class="fas fa-arrow-left"></i>
                        Kembali
                    </a>
                    @if($pengembalian->status_pengembalian == 'Menunggu Review')<button type="button" class="btn btn-success btn-compact" onclick="approveRefund({{ $pengembalian->id_pengembalian }})">
                            <i class="fas fa-check"></i>
                            Setujui
                        </button>
                        <button type="button" class="btn btn-danger btn-compact" onclick="rejectRefund({{ $pengembalian->id_pengembalian }})">
            ...
            <div class="compact-card">
                ...
                <div class="card-body">
                    <div class="info-row">
                        ...
                        <span class="info-value d-flex align-items-center">                            #{{ $pengembalian->id_pengembalian }}
                            <button class="copy-btn ms-2" onclick="copyToClipboard('#{{ $pengembalian->id_pengembalian }}')">
                    ...
                    <div class="info-row">
                        ...
                        <span class="info-value">                            @if($pengembalian->status_pengembalian == 'Menunggu Review')
                                <span class="status-badge bg-warning text-dark">
                                    <i class="fas fa-clock me-1"></i>{{ $pengembalian->status_pengembalian }}
                                </span>
                            @elseif($pengembalian->status_pengembalian == 'Disetujui')
                                <span class="status-badge bg-success text-white">
                                    <i class="fas fa-check me-1"></i>{{ $pengembalian->status_pengembalian }}
                                </span>
                            @elseif($pengembalian->status_pengembalian == 'Ditolak')
                                <span class="status-badge bg-danger text-white">
                                    <i class="fas fa-times me-1"></i>{{ $pengembalian->status_pengembalian }}
                                </span>
                            @endif
                        </span>
                    </div>
                    ...
                    </div>                    @if($pengembalian->catatan_admin && $pengembalian->status_pengembalian == 'Ditolak')
                    <div class="info-row">
                        <span class="info-label">
                    ...
                    <div class="info-row">
                        ...
                        <span class="info-value">
                            ...
                            @if($photos && count($photos) > 0)
                                <div class="d-flex flex-wrap gap-2 mt-2">
                                    ...
                                    <div class="position-relative">
                                        <img src="{{ asset('storage/' . $photo) }}"
                                             ...
                                             onclick="showPhotoModal('{{ asset('storage/' . $photo) }}', 'Foto Bukti {{ $index + 1 }}')">
                                ...
                                <small class="text-muted mt-2 d-block">Klik foto untuk melihat ukuran penuh</small>
                            @else
        ...
        <div class="col-lg-4">
                ...
                <div class="card-body">
                    @if($pengembalian->pesanan)
                        <div class="info-row">
                            ...
                            <span class="info-value">
                                <span class="badge bg-info">{{ $pengembalian->pesanan->status_pesanan }}</span>
                            </span>
                        </div>
                        <div class="info-row">
            ...
            <div class="compact-card">
                ...
                <div class="card-body">
                    ...
                    </div>                    @if($pengembalian->status_pengembalian == 'Disetujui')
                        <div class="timeline-item">
            ...
            </div>            <!-- Bank Information (if available) -->
                    ...
                    @if($pengembalian->nomor_rekening)
                        <div class="info-row">
                            ...
                            <span class="info-value d-flex align-items-center">
                                ...
                                <button class="copy-btn ms-2" onclick="copyToClipboard('{{ $pengembalian->nomor_rekening }}')">
                                    <i class="fas fa-copy"></i>
                                </button>
                            </span>
                        </div>
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body text-center">
                <img id="photoModalImage" src="" alt="Foto Bukti" class="img-fluid" style="max-height: 70vh;">
            </div>
            ...
            <div class="header-content">
                <div class="header-info">
                    <h1>
                        ...
                        Detail Pengajuan Pengembalian #{{ $pengembalian->id_pengembalian }}
                    </h1>
                    <p>
    ...
    <div class="content-grid">
        ...
        <div class="sidebar-column">
            ...
            <div class="modern-card">
                ...
                <div class="card-body">
                    ...
                    </div>                    <!-- Status Update Form -->
                    <form id="statusUpdateForm" action="{{ route('admin.pengembalian.updateStatus', $pengembalian->id_pengembalian) }}" method="POST">
                        @csrf
        ...
        <div class="main-column">
                    ...
                    <div class="info-grid">
                        ...
                        <div class="info-section">
                            ...
                            <div class="info-item">
                                ...
                                <span class="amount highlight">Rp {{ number_format($pengembalian->jumlah_klaim, 0, ',', '.') }}</span>
                            </div>
                        </div>
                    </div>
            ...
            <div class="modern-card">
                ...
                <div class="card-body">
                    <div class="info-grid">                        <div class="info-section">
                            <div class="info-item">
                        ...
                        <div class="info-section">
                            <div class="info-item">
                                <strong>Metode Refund:</strong>
                                <span class="modern-badge badge-secondary">{{ $pengembalian->metode_refund }}</span>
                            </div>
                        </div>
                    </div>                    @if($pengembalian->deskripsi_masalah)
            ...
            <!-- E-Wallet Information (if available) -->
            ...
            <div class="compact-card">
                ...
                <div class="card-body">
                    ...
                    @if($pengembalian->nomor_ewallet)
                        <div class="info-row">
                            <span class="info-label">No. E-Wallet</span>
                            <span class="info-value d-flex align-items-center">
                                {{ $pengembalian->nomor_ewallet }}
                                <button class="copy-btn ms-2" onclick="copyToClipboard('{{ $pengembalian->nomor_ewallet }}')">
                                    <i class="fas fa-copy"></i>
                                </button>
                            </span>
                        </div>
...
<div class="modern-modal fade" id="approveModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ route('admin.pengembalian.approve', $pengembalian->id_pengembalian) }}" method="POST">
                @csrf
                <div class="modal-body">
...
<div class="modern-modal fade" id="rejectModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ route('admin.pengembalian.reject', $pengembalian->id_pengembalian) }}" method="POST">
                @csrf
                <div class="modal-body">
...
<div class="modern-modal fade" id="refundModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ route('admin.pengembalian.markRefunded', $pengembalian->id_pengembalian) }}" method="POST">
                @csrf
                <div class="modal-body">
                    <div class="alert-primary">
                        <i class="fas fa-money-bill-wave"></i>
                        Konfirmasi bahwa dana sebesar <strong>Rp {{ number_format($pengembalian->jumlah_klaim, 0, ',', '.') }}</strong>
    ...
    updateStatusBtn.addEventListener('click', function(e) {
        ...
        switch(selectedStatus) {
            ...
            case 'Dana Dikembalikan':
                ...
                text = `Konfirmasi bahwa dana sebesar Rp {{ number_format($pengembalian->jumlah_klaim, 0, ',', '.') }} telah ditransfer ke rekening pelanggan dengan nomor transaksi: ${transactionNumber}`;
...
window.submitApproveForm = function(notes) {
    ...
    const form = document.createElement('form');
    form.method = 'POST';
    form.action = '{{ route("admin.pengembalian.approve", $pengembalian->id_pengembalian) }}';
...
window.submitRejectForm = function(notes) {
    ...
    const form = document.createElement('form');
    form.method = 'POST';
    form.action = '{{ route("admin.pengembalian.reject", $pengembalian->id_pengembalian) }}';
...
window.submitRefundForm = function(transactionNumber, notes) {
    ...
    const form = document.createElement('form');
    form.method = 'POST';
    form.action = '{{ route("admin.pengembalian.markRefunded", $pengembalian->id_pengembalian) }}';
