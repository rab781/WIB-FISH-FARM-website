...
<style>
    ...
    .timeline-item {
        @apply border-l-4 border-orange-400 pl-4 py-3 bg-orange-50 mb-4 rounded-r-lg;
    }
    ...
    <div class="page-header flex flex-wrap justify-between items-center mb-8">
        <div class="container mx-auto px-6">
            <div class="flex flex-wrap justify-between items-center">
                ...
                <div class="space-x-2">
                    <a href="{{ route('refunds.index') }}" class="bg-white text-orange-600 px-4 py-2 rounded-lg hover:bg-orange-100 transition-colors">
