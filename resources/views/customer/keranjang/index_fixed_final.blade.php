        ...
        <div class="bg-gray-50 px-4 py-6 space-y-4">
            <div class="flex items-center justify-between">
                <div class="flex items-center space-x-3">
                    <input type="checkbox" id="selectAll2" class="rounded border-gray-300 text-orange-600 focus:ring-orange-500">
                    <label for="selectAll2" class="text-sm text-gray-700">Pilih Semua</label>
