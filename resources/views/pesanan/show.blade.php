    ...
    <div class="max-w-5xl mx-auto">
        ...
        <div class="bg-white shadow-sm mb-4">
            <div class="p-4">
                ...
                <a href="{{ route('refunds.create', ['pesanan' => $pesanan->id_pesanan]) }}" class="w-full mt-2 inline-flex justify-center items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500">
                    <svg class="h-5 w-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 15v-1a4 4 0 00-4-4H8m0 0l3 3m-3-3l3-3m9 14V5a2 2 0 00-2-2H6a2 2 0 00-2 2v16l4-2 4 2 4-2 4 2z"></path>
                    </svg>
                    Ajukan Pengembalian
                </a>
                <p class="text-xs text-gray-500 mt-1 text-center">Hanya tersedia selama 24 jam setelah pesanan diterima</p>
                @endif

                @if($pesanan->is_reviewable && !$pesanan->ulasan)
                <a href="{{ route('reviews.create', ['pesanan' => $pesanan->id_pesanan]) }}" class="w-full mt-2 inline-flex justify-center items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500">
                    <svg class="h-5 w-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
