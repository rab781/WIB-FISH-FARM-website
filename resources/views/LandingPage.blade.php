            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div class="bg-gray-100 rounded-md overflow-hidden">
                    ...
                    <div class="p-4">
                        ...
                        <p class="text-sm text-gray-600 mb-3">In stock</p>
                        <button class="w-full text-center py-2 border border-gray-300 rounded-md text-sm hover:bg-gray-50">Add to cart</button>
                    </div>
                </div>
                ...
                <div class="bg-gray-100 rounded-md overflow-hidden">
                    ...
                    <div class="p-4">
                        <div class="flex justify-between items-center mb-1">
                            <h3 class="font-medium">Ikan Koi</h3>
                            <span>Rp 250.000</span>
                        </div>
                        <p class="text-sm text-gray-600 mb-3">Tersedia</p>
                        <button class="w-full text-center py-2 border border-gray-300 rounded-md text-sm hover:bg-gray-50">Tambahkan ke keranjang</button>
                    </div>
                </div>
        ...
        <div class="container mx-auto px-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="border border-gray-200 rounded-md p-6">
                    ...
                    <p class="text-gray-700 mb-4">"Saya sangat senang dengan pelayanan perusahaan ini. Harga terjangkau dan kualitas terbaik."</p>
                    <div class="flex items-center">
                        <div class="h-10 w-10 rounded-full bg-gray-200 flex-shrink-0"></div>
                        <div class="ml-3">
                            <p class="font-medium">Adit Prasetyo</p>
                ...
                <div class="border border-gray-200 rounded-md p-6">
                    ...
                    <p class="text-gray-700 mb-4">"Produk sangat berkualitas dan pengiriman tepat waktu. Saya akan berlangganan lagi."</p>
                    <div class="flex items-center">
                        <div class="h-10 w-10 rounded-full bg-gray-200 flex-shrink-0"></div>
                        <div class="ml-3">
                            <p class="font-medium">Edi Kusnadi</p>
                            <p class="text-sm text-gray-500">Malang, Jawa Timur</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="border border-gray-200 rounded-md p-6">
                    ...
                    <p class="text-gray-700 mb-4">"Pelayanan customer service yang sangat responsif dan ramah. Terimakasih!"</p>
                    <div class="flex items-center">
                        <div class="h-10 w-10 rounded-full bg-gray-200 flex-shrink-0"></div>
                        <div class="ml-3">
                            <p class="font-medium">Yudi Santoso</p>
                            <p class="text-sm text-gray-500">DKI, Jakarta Selatan</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="flex items-start">
                            ...
                            <div class="ml-3">
                                ...
                                <p class="text-sm text-gray-500">info@wibfishfarm.co.id</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start">
                            ...
                            <div class="ml-3">
                                ...
                                <p class="text-sm text-gray-500">+62 813-5555-6789</p>
                            </div>
                        </div>
