...
">
    ...
    <div x-show="open"
        ...
        <div id="notification-container" class="bg-pink-50">
            <!-- Loading indicator -->
            ...
            <div id="notification-list" class="divide-y divide-pink-100"></div>

            <!-- Empty state -->
            <div id="notification-empty" class="p-6 text-center text-gray-500" style="display:none;">
...
<script>
// Define the loadNotifications function in global scope to make it accessible
