...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.D:\Project Pribadi\test1\public\storage' => 'string',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.D:\\Project Pribadi\\test1\\public\\storage',
...
'view.compiled','sanctum.stateful','sanctum.guard','sanctum.expiration','sanctum.token_prefix',
...
'sanctum.csrf-cookie','home','produk.index',
'detailProduk','produk.reviews','tentang-kami','alamat.store','keranjang.index',
'keranjang.store','keranjang.updatepost','keranjang.destroy.post','keranjang.bulk-delete','checkout.process',
'checkout.store','checkout','alamat.tambah','alamat.simpan','checkout.ongkir',
'pesanan.index','pesanan.show','pembayaran.upload','pesanan.payment','pesanan.konfirmasi',
'pesanan.payment-proof','keluhan.index','keluhan.create','keluhan.store','keluhan.show',
'pesanan.tracking','pesanan.delivery-status','pesanan.track-shipping','pesanan.review','pesanan.invoice',
'pesanan.cancel','pesanan.statistics','refunds.index','refunds.show','refunds.create',
'refunds.store','pesanan.timeline','reviews.index','reviews.show','reviews.create',
'reviews.store','reviews.interaction','profile.show','profile.edit','profile.update',
'profile.search-alamat','notifications.index','notifications.mark-as-read','notifications.mark-all-as-read','notifications.unread-count',
'pesanan.editAlamat','pesanan.update-alamat','checkout.editAlamat','register',
'login','logout','admin.dashboard',
'admin.reports.sales','admin.reports.financial','admin.expenses.index','admin.expenses.create','admin.expenses.store',
'admin.expenses.show','admin.expenses.edit','admin.expenses.update','admin.expenses.destroy','admin.keluhan.index',
'admin.keluhan.show','admin.keluhan.respond','admin.profile.show','admin.profile.edit','admin.profile.update',
'admin.keluhan.respond','admin.notifications.index','admin.pesanan.index','admin.pesanan.show','admin.pesanan.edit',
'admin.pesanan.updateStatus','admin.pesanan.forceExpire','admin.pesanan.process','admin.pesanan.ship','admin.pesanan.confirm-payment',
'admin.pesanan.cancel','admin.pesanan.payment-proof','admin.users.index','admin.users.show','admin.users.edit',
'admin.users.update','admin.users.toggle-active','admin.produk.index','admin.produk.create','admin.produk.store',
'admin.produk.show','admin.produk.edit','admin.produk.update','admin.produk.destroy','admin.produk.restore',
'admin.produk.forceDelete','admin.pesanan.dashboard','admin.pesanan.statistics','admin.pesanan.export','admin.pesanan.bulk-action',
'admin.pesanan.timeline','admin.pesanan.timeline.add','admin.refunds.index','admin.refunds.show','admin.refunds.process',
'admin.refunds.dashboard','admin.refunds.export','admin.reviews.index','admin.reviews.moderate','admin.reviews.statistics',
'admin.reviews.show','admin.reviews.addAdminReply','admin.reviews.updateStatus','admin.reviews.bulkModerate','admin.diagnostic.payment-proofs',
'admin.expenses.export','page-expired','cart.add',
'cart.view','cart.remove','cart.bulk-delete','cart.count',
'index','diagnosa-api','test-rajaongkir-api','test-komerce','test-standard',
'debug-http-request','test-domestic-cost','cek-tracking','public.search-alamat','web.cek-ongkir',
'shipping-calculator','auth.google','auth.google.callback','test.raja-ongkir-search',
'test.api-response','test.debug','test.enhanced-search','test.rate-limiter','storage.local',);
        registerArgumentsSet('views',
'admin.dashboard','admin.debug.api_status','admin.diagnostic.payment-proofs','admin.expenses.create','admin.expenses.edit',
'admin.expenses.index','admin.expenses.show','admin.keluhan.index','admin.keluhan.show','admin.layouts.app',
'admin.notifications.index','admin.pesanan.index','admin.pesanan.show','admin.produk.create','admin.produk.edit',
'admin.produk.index','admin.produk.show','admin.profile.edit','admin.profile.show','admin.refunds.index',
'admin.refunds.show','admin.reports.financial','admin.reports.sales','admin.reviews.index','admin.reviews.moderate',
'admin.reviews.show','admin.reviews.statistics','alamat.edit','auth.login','auth.register',
'cart-contoh','components.admin-notification-dropdown','components.admin.notification-dropdown','components.auth-session-status','components.customer.notification-dropdown',
'components.input-error','components.input-label','components.primary-button','components.text-input','customer.catalog',
'customer.notifications.index','customer.pesanan.checkout','customer.profile.edit','customer.profile.show','customer.quarantine.show',
'customer.refunds.create','customer.refunds.index','customer.refunds.show','customer.reviews.create','customer.reviews.index',
'customer.reviews.show','diagnosa-api','errors.404','errors.419','home.detail',
'home.index','home.produk','home.tentang-kami','index','keluhan.create',
'keluhan.index','keluhan.show','keranjang.index','layouts.admin','layouts.app',
'layouts.customer','layouts.guest','layouts.navigation','partials.footer','partials.navbar',
'partials.product-card','pesanan.checkout','pesanan.edit_alamat','pesanan.index','pesanan.payment-upload',
'pesanan.show','pesanan.tambah_alamat','produk.-contoh','public.reviews.index','public.reviews.show',
'shipping-calculator','test.api-response','test.debug','test.enhanced-search','test.raja-ongkir-search',
'test.rate_limiter_test','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context','laravel-exceptions-renderer::components.editor','laravel-exceptions-renderer::components.header',
...
'RAJA_ONGKIR_API_KEY','STORE_LOCATION_ID','GOOGLE_CLIENT_ID','GOOGLE_CLIENT_SECRET','GOOGLE_REDIRECT_URI',);
